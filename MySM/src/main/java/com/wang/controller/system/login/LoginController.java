package com.wang.controller.system.login;
...
import com.wang.entity.system.Menu;
import com.wang.entity.system.Role;
import com.wang.entity.system.User;
...
import com.wang.util.RightsHelper;
...
public class LoginController extends BaseController {
	...
	public Object login() throws Exception {
		...
		pd = this.getPageData();
		String errInfo = "";
		String KEYDATA[] = pd.getString("KEYDATA").replaceAll("wang", "").replaceAll("xiaokun", "").split(",yali,");
		System.out.println(pd.getString("KEYDATA"));
